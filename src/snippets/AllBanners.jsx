...
function AllBanners(props) {
  return (
    <section className="bg-[url('./assets/img/all-banners-img.png')] bg-cover bg-center bg-no-repeat flex items-center justify-center relative h-[340px] md:h-[406px]">
      <div className="absolute left-2/4 -translate-x-2/4 bottom-[94px] flex items-center justify-center gap-[30px] flex-col">
        <h3 className="inline-block whitespace-nowrap font-normal font-aa text-white text-[36px] leading-[48px] sm:text-[48px] sm:leading-[64px] md:text-[64px] md:leading-[86px] lg:text-[82px] lg:leading-[110.62px]">
          {props.name}
        </h3>
